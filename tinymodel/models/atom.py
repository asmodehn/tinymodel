...
class AtomInt:
    ...
    '42'
    """
    impl_type: typing.Type[int] = int  # reminder: ints are infinite in python
    field: fields.Integer = fields.Integer()
    #strategy: strats.SearchStrategy  # TODO ...

    def __init__(self, value: int):  # static type check for user code.
        self.value = value
...
class AtomStr:
    ...
    'answer'
    """
    impl_type: typing.Type[str] = str
    field: fields.String = fields.String()
    #strategy: strats.SearchStrategy  # TODO ...

    def __init__(self, value: str):  # static type check for user code.
        self.value = value
    ...
    # Note : This is the unambiguous interface. Safe, use for "external"/deterministic/automated communication
    def __repr__(self):
        return self.value  # we use the python str semantic here, for "out-of-python" conversion, see schemas.
